...
const CollaborationSection = () => {
  ...
  const renderTitle = () => (
    ...
    >
      Thank you for everything you do for me, I <span className="text-strong font-bold"> love </span> you, Fifa🐷.
    </h1>
  );
  ...
  return (
    <section className={COLLABORATION_STYLE.SECTION} ref={targetSection}>
      {renderSlidingText(
      " Fifa, I want to live with you and support you in every situation ",
      "ui-left"
      )}
