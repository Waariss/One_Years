...
const QuoteSection = () => {
  ...
  const renderQuote = (): React.ReactNode => (
    <div className="tall:py-60 py-72 section-container">
      ...
      >
        I will <span className="text-strong font-bold">always</span> be with you, in every <span className="text-strong font-bold">place</span> and every <span className="text-strong font-bold">moment</span>, steadfast in our journey together.
      </h1>
    </div>
  );
